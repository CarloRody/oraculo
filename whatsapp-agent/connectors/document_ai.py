...
DEFAULT_CHRONOLOGICAL_PROMPT_HEADER = (
    ...
    "Eles JÁ ESTÃO ORDENADOS pela data real do exame/laudo, quando foi "
    "possível identificá-la no texto do próprio resumo — nos poucos casos "
    "sem data identificada, o documento aparece pela ordem de recebimento "
    "no WhatsApp, como aproximação (marcado como tal no rótulo). Você pode "
    "seguir essa ordem diretamente, sem precisar reordenar por conta "
    "própria.\n\n"
    ...
    "quando duas entradas com a mesma data claramente pertencem ao mesmo "
    "laudo/exame, junte-as numa única entrada da linha do tempo, "
    "preservando TODOS os achados de ambas (nunca descarte um achado que "
    "apareça em só uma das duas).\n\n"
    "Sua tarefa: escrever UMA lista cronológica única, em português, cada "
    "exame/laudo aparecendo UMA ÚNICA VEZ, na ordem dada. NÃO escreva uma "
    ...
    "correspondente.\n\nResumos individuais, do mais antigo pro mais "
    "recente:\n"
)
